...
from visualize_simple_unreduced_3 import visualize_simple_unreduced_3
...
variations_initials = [None, None, None, None, None, None]
# variations_coefficients = [np.linspace(0.6, 1.4, 6), None, None, None]
is_focus_initials = [False, False, False, False, False, False]
is_focus_coefficients = [True, False, False, False]

variations_coefficients = [np.linspace(1.3, 1.35, 20), None, None, None]
...
visualize_simple_unreduced_3(f, initials_list, coefficients_list, interval_list,
